...
@section('content')
    ...
    ══ --}}
            <form action="{{ route('parent.inscription.store') }}" method="POST" enctype="multipart/form-data"
                id="inscriptionForm" novalidate>
                    ...
                    <div class="step-panel active" id="panel-1">
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Téléphone principal <span
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="lien_parente"
                                        ...
                                        @foreach (['Père', 'Mère', 'Tuteur légal', 'Grand-parent', 'Autre'] as $lien)
                                            <option value="{{ $lien }}"
                                                {{ old('lien_parente') === $lien ? 'selected' : '' }}>
                                                {{ $lien }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label">Adresse complète <span
                                            class="required-star">*</span></label>
                                    <div class="input-icon-wrap">
                            ...
                            <div class="form-actions">
                                <div class="text-muted" style="font-size:.82rem">
                                    <i class="bi bi-asterisk text-danger me-1" style="font-size:.7rem"></i>Champs
                                    obligatoires
                                </div>
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="row g-4 mb-2">
                                ...
                                <div class="col-md-3 text-center">
                                    ...
                                    <label class="avatar-upload">
                                        ...
                                        <input type="file" name="eleve_photo" accept="image/*" class="d-none"
                                            onchange="previewAvatar(this)">
                                    </label>

                                    <small class="text-muted d-block mt-2">
                                        Cliquer sur la photo pour choisir<br>
                                        JPG, PNG — max 2 Mo
                                    </small>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-4">
                                    ...
                                    <select name="eleve_sexe" id="eleve_sexe" class="form-select">
                                        <option value="">-- Sélectionner --</option>

                                        <option value="M" {{ old('eleve_sexe') == 'M' ? 'selected' : '' }}>
                                            Masculin
                                        </option>

                                        <option value="F" {{ old('eleve_sexe') == 'F' ? 'selected' : '' }}>
                                            Féminin
                                        </option>
                                    </select>
                                    ...
                                    <select name="niveau_souhaite"
                                        ...
                                        <optgroup label="Maternelle">
                                            @foreach (['Petite Section (PS)', 'Moyenne Section (MS)', 'Grande Section (GS)'] as $n)
                                                <option value="{{ $n }}"
                                                    {{ old('niveau_souhaite') === $n ? 'selected' : '' }}>
                                                    {{ $n }}</option>
                                            @endforeach
                                        </optgroup>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="resultat_precedent" class="form-select">
                                        ...
                                        @foreach (['Admis(e)', 'Ajourné(e)', '1ère scolarisation'] as $r)
                                            <option value="{{ $r }}"
                                                {{ old('resultat_precedent') === $r ? 'selected' : '' }}>
                                                {{ $r }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select name="groupe_sanguin" class="form-select">
                                        ...
                                        @foreach (['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'] as $g)
                                            <option value="{{ $g }}"
                                                {{ old('groupe_sanguin') === $g ? 'selected' : '' }}>{{ $g }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <label class="file-upload-zone @error('doc_acte_naissance') border-danger @enderror"
                                        ...
                                        <div class="flex-1">
                                            <p id="label-acte">Glisser-déposer ou <span
                                                    style="color:var(--blue);font-weight:600">parcourir</span></p>
        ...
        ═══════════════════════════════════════ --}}
                    <div class="step-panel" id="panel-4">
                        <div class="card-header-custom" style="background:linear-gradient(110deg,#064E3B,#065F46)">
                            ...
                            <span class="step-badge" style="border-color:rgba(52,211,153,.3);color:#34D399">Étape 4 /
                                4</span>
                        </div>
                        <div class="card-body-custom">

                            <div class="info-banner"
                                style="border-left-color:#10B981;background:rgba(16,185,129,.06);border-color:rgba(16,185,129,.15)">
                            ...
                            <div class="mt-3 p-3 rounded-3"
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="termsCheck"
                                        ...
                                        <a href="#" style="color:var(--blue)">règlement intérieur de
                                            l'établissement</a>
                                        et la <a href="#" style="color:var(--blue)">politique de
                                            confidentialité</a>.
                                    </label>
                                </div>
                                @error('conditions')
    ...
    <style>
        ...
        *::after {
        ...
        body::before {
            ...
            position: fixed;
            inset: 0;
            background: radial-gradient(ellipse 80% 50% at 10% 20%, rgba(37, 99, 235, .08) 0%, transparent 60%), radial-gradient(ellipse 60% 40% at 90% 80%, rgba(56, 189, 248, .07) 0%, transparent 60%);
            pointer-events: none;
            z-index: 0;
        }
        ...
        .step-item.pending .step-label strong {
        ...
        .step-item.active .step-label span {
            color: var(--sky);
        }
        ...
        .card-header-custom {
            background: linear-gradient(110deg, var(--navy) 0%, var(--royal) 100%);
            padding: 1.6rem 2rem;
            display: flex;
            align-items: center;
            gap: 1rem;
        ...
        .file-upload-zone.file-ok {
            border-color: var(--success);
            background: rgba(16, 185, 129, .04);
        }

        .file-upload-zone .file-icon {
            width: 48px;
            height: 48px;
            flex-shrink: 0;
            background: var(--light);
        ...
        .info-banner {
            background: linear-gradient(135deg, rgba(37, 99, 235, .07), rgba(56, 189, 248, .07));
    ...
    <script>
        ...
        function validerEtape(step) {
            ...
            if (step === 2) {
                ...
                // Sexe
                if (!document.getElementById('eleve_sexe').value) {
        ...
        function selectGender(el, val) {
            ...
            document.getElementById('eleve_sexe').value = val;
        }
        ...
        function remplirRecapitulatif() {
            ...
            const docs = [{
                ...
                {
                    name: 'doc_photo_identite',
                    label: "Photo d'identité élève",
                    required: true
                },
            ];
