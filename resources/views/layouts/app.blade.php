...
<head>
  ...
  {{-- ══════════════════════════════════════════
       CSS COMMUN — valable sur toutes les pages
  ════════════════════════════════════════════ --}}
  <style>
    /* ── Variables globales ── */
    :root {
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar::before {
      ...
      background: rgba(56,189,248,.05); pointer-events: none;
    }
    ...
    .school-role {
      ...
      letter-spacing: .08em; text-transform: uppercase; margin-top: .18rem;
    }
    ...
    .nav-section-label {
      ...
      padding: .3rem .6rem; margin: .9rem 0 .4rem;
    }
    .nav-item {
    ...
    .nav-item.active {
      ...
      color: #fff; border-left-color: var(--sky);
    }
    .nav-item.active i { color: var(--sky); }
    .nav-item-child { padding-left: 2.7rem; font-size: .84rem; }
    .nav-badge {
      margin-left: auto; background: var(--rose); color: #fff;
      font-size: .68rem; font-weight: 700;
      border-radius: 20px; padding: .12rem .5rem; min-width: 20px; text-align: center;
    }
    ...
    .user-pill strong { display: block; color: #fff; font-size: .84rem; line-height: 1.3; }
    .user-pill span   { color: rgba(255,255,255,.4); font-size: .74rem; }
    ...
    .topbar-title {
      font-family: 'Playfair Display', serif;
      font-size: 1.05rem; color: var(--navy); line-height: 1.2;
    }
    .topbar-sub { color: var(--slate); font-size: .78rem; margin-top: .1rem; }
    .topbar-icon {
      width: 36px; height: 36px; border-radius: 9px;
      background: var(--light); border: 1px solid var(--border);
      display: flex; align-items: center; justify-content: center;
      color: var(--slate); text-decoration: none; font-size: .95rem;
      transition: all .2s; position: relative;
    }
    .topbar-icon:hover { background: var(--blue); color: #fff; border-color: var(--blue); }
    .notif-dot {
    ...
    .alert-flash-error {
      background: rgba(244,63,94,.1); color: #9F1239;
    ...
    .btn-primary-gu {
      ...
      padding: .6rem 1.3rem; font-family: 'DM Sans', sans-serif;
    ...
    .btn-primary-gu:hover {
      ...
      box-shadow: 0 7px 22px rgba(37,99,235,.4); color: #fff;
    }
    .btn-outline-gu {
      display: inline-flex; align-items: center; gap: .45rem;
    ...
    .btn-outline-gu:hover { border-color: var(--blue); color: var(--blue); background: var(--light); }
    .btn-danger-gu {
      display: inline-flex; align-items: center; gap: .45rem;
      background: rgba(244,63,94,.1); border: 1.5px solid rgba(244,63,94,.25);
      color: #9F1239; border-radius: 9px;
      padding: .6rem 1.3rem; font-size: .88rem; font-weight: 600;
      text-decoration: none; transition: all .2s; cursor: pointer;
    }
    .btn-danger-gu:hover { background: var(--rose); color: #fff; border-color: var(--rose); }
    ...
    .badge-attente  { background: rgba(245,158,11,.1); color: #B45309; border: 1px solid rgba(245,158,11,.25); }
    .badge-validee  { background: rgba(16,185,129,.1); color: #065F46; border: 1px solid rgba(16,185,129,.25); }
    .badge-refusee  { background: rgba(244,63,94,.1);  color: #9F1239; border: 1px solid rgba(244,63,94,.25); }
    .badge-info     { background: rgba(37,99,235,.1);  color: #1E40AF; border: 1px solid rgba(37,99,235,.2); }
    ...
    .card-gu-header h5 {
      font-family: 'Playfair Display', serif;
      font-size: .98rem; color: var(--navy); margin: 0;
      display: flex; align-items: center; gap: .5rem;
    }
    .card-gu-header h5 i { color: var(--blue); }
    .card-gu-body { padding: 1.2rem 1.4rem; }
    ...
    .section-head h5 i { color: var(--blue); }
    .link-sm {
    ...
    .empty-state i { font-size: 2.4rem; opacity: .3; display: block; margin-bottom: .8rem; }
    ...
    .anim-up.delay-2  { animation-delay: .16s; }
    .anim-up.delay-3  { animation-delay: .24s; }
    .anim-up.delay-4  { animation-delay: .32s; }

    /* ── Responsive ── */
    @media (max-width: 991px) {
      :root { --sidebar-w: 230px; }
      .page-body { padding: 1.4rem; }
    }
